      ...
      >
        <View style={styles.column}>
          ...
          <Text style={styles.text}>
            {secondTeam ? secondTeam[1] : 'No data'}
          </Text>
          <View
            style={[
              styles.rankView,
          ...
          <Text style={styleFont.Title}>
            {secondTeam ? secondTeam[2] : 'No data'}
          </Text>
